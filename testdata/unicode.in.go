...
// Le café était délicieux et très chaud, mais le résumé était trop naïf pour moi ici.
func docstringWithAccents() string

// This signature's byte length exceeds the wrap column but its rune length does not.
